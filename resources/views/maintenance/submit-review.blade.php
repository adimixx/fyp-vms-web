...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            <div>
                <h3 class="text-dark mb-0">Maintenance Request Review Submission</h3>
                <p class="text-secondary">Please review the maintenance request details before submitting for review</p>
            </div>
            <div>
                <a href="{{ route('maintenance.show', $maintenance->id) }}" class="text-decoration-none">
                    <button class="btn btn-primary"><i class="fas fa-times-circle"></i> Cancel Review</button>
                </a>
            </div>
        </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <p class="text-secondary"><span class="fw-bold">Alert :</span> Please ensure all information
                                entered
                                are precise and sufficient before submitting for review</p>

                            <div class="d-flex justify-content-center">
                                <div class="mr-2">
                                    <button class="btn btn-secondary"
                                        href="{{ route('maintenance.show', $maintenance->id) }}">Cancel</button>
                                </div>


                                <form method="POST"
                                    action="{{ route('maintenance.submit-review-post', $maintenance->id) }}">
                                    @csrf
