            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <maintenance-create
                        ...
                        maintenance-unit-name="{{ $maintenance->maintenanceUnit->name }}"
                        :is-update="true"
                    ...
                    <div class="card-body">
                        <div>
                            <div class="mb-2">
                                ...
                                <h4 class="text-uppercase text-primary mb-0 mt-0 fw-bold">{{ $maintenance->complaint->name }}</h4>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        <p class="text-secondary mb-0">Complaint Description : </p><span
                                            class="text-uppercase text-dark fw-bold">{{ $maintenance->complaint->detail }} KM</span>
                                    </div>
                                </div>
                                <div class="col-12">
