...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            <div>
                <h3 class="text-dark mb-0">Maintenance Request Approval Review</h3>
                <p class="text-secondary">Please review the maintenance request details</p>
            </div>
            <div>
                <a href="{{ route('maintenance.show', $maintenance->id) }}" class="text-decoration-none">
                    <button class="btn btn-secondary"><i class="fas fa-times-circle"></i> Cancel Review</button>
                </a>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="text-primary m-0 fw-bold">Confirm Maintenance Request Submission</h6>
                    </div>
                    <div class="card-body">
                        <div class="text-center">
                            <p class="text-secondary"><span class="fw-bold">Alert :</span> Please ensure all information are
                                reviewed before submission</p>
                        </div>

                        <maintenance-approval-review-form :status-options="{{ $statusOption }}" submit-url="{{ route('api.data.maintenance-request.approval-review') }}"
                            back-url="{{ route('maintenance.index') }}" :id="{{ $maintenance->id }}"></maintenance-approval-review-form>
                    </div>
                </div>
            </div>
        </div>
